...
public class LzwTests
{
    ...
    public void Test1()
    {
        FilterTestHelpers.TestFilter(PdfFilter.Lzw, "this is a test of the lzw filter");
    }
    
    [Fact]
    public void Test2()
    {
        FilterTestHelpers.TestFilter(PdfFilter.Lzw, "this?");
    }
    
    [Fact]
    public void Test3()
    {
        FilterTestHelpers.TestFilter(PdfFilter.Lzw, @"
